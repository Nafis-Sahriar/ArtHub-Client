    ...
    <>
      ...
      <>
        ...
        <Pagination className="w-full">
          ...
          <Pagination.Summary className="text-gray-400">
          ...
          <Pagination.Content>
            ...
            <Pagination.Item>
              ...
              <Pagination.Next className="text-white hover:text-[#CFE1B9]" isDisabled={page === totalPages} onPress={() => setPage((p) => p + 1)}>
                <span>Next</span>
                <Pagination.NextIcon />
              </Pagination.Next>
            </Pagination.Item>
        ...
        <div className="text-center py-20 bg-white/5 backdrop-blur-md border border-[#CFE1B9]/20 rounded-3xl shadow-sm max-w-7xl mx-auto">
          <p className="text-gray-400 text-lg">No artworks match your search criteria.</p>
        </div>
      )}
    </>
  );
