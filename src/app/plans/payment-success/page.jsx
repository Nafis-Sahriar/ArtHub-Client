...
export default async function SuccessPayment({ searchParams }) {
    ...
    if (status === 'complete') {
        ...
        console.log("Purchase Data to be sent to server:", purchaseData);
            ...
            <div className="w-full min-h-screen bg-zinc-950 text-zinc-50 flex flex-col justify-center items-center p-6 select-none">
                ...
                >
                    ...
                    <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                        We appreciate your business! You have bought the product.
                    </p>
